...
- Operating manual: mental models, coding standards, workflow rules, 11 ADRs
- ADR-011: Naming change from agenson → AgentSON (`.ason` collision with existing packages)
