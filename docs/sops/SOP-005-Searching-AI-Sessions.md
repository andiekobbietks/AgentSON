...
Select-String -Path "C:\Users\LLM-Test\Downloads\*.AgentSON" -Pattern "nightscout"
```
...
Get-ChildItem "C:\Users\LLM-Test\Downloads\*.AgentSON" | Select-String -Pattern "function"
```
...
Select-String -Path "C:\Users\LLM-Test\Downloads\*.AgentSON" -Pattern "error" -Context 2,2
```
...
Select-String -Path "C:\Users\LLM-Test\Downloads\*.AgentSON" -Pattern '"code":'
```
