...
python -m cli.main render "C:\Users\LLM-Test\Downloads\libre_libre_data.AgentSON" --format html --output "C:\Users\LLM-Test\Downloads\glucose_report.html"
```

### Step 2: Open Report in Browser

```powershell
Start-Process "C:\Users\LLM-Test\Downloads\glucose_report.html"
```
