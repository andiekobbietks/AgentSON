...
python -m cli.main export --tool opencode --session ses_xxx --output "C:\Users\LLM-Test\Downloads"

# Export specific MiniMax session
python -m cli.main export --tool minimax --session xxx --output "C:\Users\LLM-Test\Downloads"
```
...
python -m cli.main export --tool opencode --all --output "C:\Users\LLM-Test\Downloads"

# Export all MiniMax sessions
python -m cli.main export --tool minimax --all --output "C:\Users\LLM-Test\Downloads"
```
